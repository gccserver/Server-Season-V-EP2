...
SkillTree 	=
{
    ...
    {		
		...
		SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS3_SPECIAL4,
			MonsterModeMana = 3.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS3_SPECIAL1,
			MonsterModeMana = 0.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS3_SPECIAL2,
			MonsterModeMana = 1.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS3_SPECIAL3,
			MonsterModeMana = 2.9,
