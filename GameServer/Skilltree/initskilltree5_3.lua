...
SkillTree 	=
{
    ...
    {		
		...
		SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_SPECIAL4,
			CoolTime = 45,
			
			MonsterModeMotion = MID_RONAN4_SPECIAL4,
			MonsterModeMana = 3.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL1_READY,
			CoolTime = 10,
			
			MonsterModeMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL1_READY,
			MonsterModeMana = 0.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL2,
			CoolTime = 20,
			
			MonsterModeMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL2,
			MonsterModeMana = 1.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL3,
			CoolTime = 30,
			
			MonsterModeMotion = MID_RONAN4_MAGIC_SWORD_SPECIAL3,
			MonsterModeMana = 2.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL1,
			CoolTime = 10,
			
			MonsterModeMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL1,
			MonsterModeMana = 0.9,
			MonsterModeCoolTime = 10,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL2_READY,
			CoolTime = 20,
			
			MonsterModeMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL2_READY,
			MonsterModeMana = 1.9,
			MonsterModeCoolTime = 18,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			AddMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL3,
			CoolTime = 30,
			
			MonsterModeMotion = MID_RONAN4_WHITE_MAGIC_SPECIAL3,
			MonsterModeMana = 2.9,
			MonsterModeCoolTime = 26,
