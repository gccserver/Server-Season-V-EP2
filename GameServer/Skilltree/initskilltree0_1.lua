...
SkillTree 	=
{
    ...
    {		
		...
		SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS2_SPECIAL4,
			MonsterModeMana = 3.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS2_SPECIAL1,
			MonsterModeMana = 0.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS2_SPECIAL_FLYING_IMPACT,
			MonsterModeMana = 0.9,
			MonsterModeCoolTime = 10,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS2_SPECIAL2,
			MonsterModeMana = 1.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ELESIS2_SPECIAL3,
			MonsterModeMana = 2.9,
