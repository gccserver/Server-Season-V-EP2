...
SkillTree 	=
{
    ...
    {		
		...
		SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL4,
			MonsterModeMana = 3.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL1_BLACK,
			MonsterModeMana = 0.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL_BIG_HAND,
			MonsterModeMana = 0.9,
			MonsterModeCoolTime = 10,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL2_BLACK,
			MonsterModeMana = 1.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL3_BLACK,
			MonsterModeMana = 2.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL1,
			MonsterModeMana = 0.9,
			MonsterModeCoolTime = 10,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL2,
			MonsterModeMana = 1.9,
			MonsterModeCoolTime = 18,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_ARME2_SPECIAL3,
			MonsterModeMana = 2.9,
			MonsterModeCoolTime = 26,
