...
SkillTree 	=
{
    ...
    {		
		...
		SlotSkill = 
		{
			...
			MonsterModeMotion = MID_LIRE4_SPECIAL4,
			MonsterModeMana = 3.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_LIRE4_SPECIAL1,
			MonsterModeMana = 0.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_LIRE4_SPECIAL2,
			MonsterModeMana = 1.9,
    ...
    {		
        ...
        SlotSkill = 
		{
			...
			MonsterModeMotion = MID_LIRE4_SPECIAL3,
			MonsterModeMana = 2.9,
