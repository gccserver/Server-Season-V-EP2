...
GroupItem =
{
    ...
    { GroupType = PROTECT_RING, ItemList = {12710, 51300, 35030, 17510, 19360, 28850, 28860, 745470,1489410,1668760,1876950,1909010 }, }, --팀 전체부활
    ...
    { GroupType = EVENT_POTION, ItemList = { 558980, 559010, 559020, 559030, 559040, 559050, 559060, 559070, 1064160, 1025680, 1909020, }, }, -- 이벤트포션
