...
GroupItem =
{
	{ GroupType = HP_POTION, ItemList = {58730,	58720, 58710, 1231090, 109810, 114800, 175710, 162730, 149880,	308520,	367150,	547570,	558990,	436300,	746070,	946730,	946750,	1293210,1025660,140090,1489390,1668740, }, }, -- HP
    { GroupType = MP_POTION, ItemList = {58760,	58750,	58740,	206880,	109820,	114810,	175700,	162720,	149890,	308530,	547580,	559000,	436290,	746080,	946740,	1293220,1025670,140100,1489400,1856500,1668750, }, }, -- MP
    { GroupType = PROTECT_RING, ItemList = {12710, 51300, 35030, 17510, 19360, 28850, 28860, 745470,1489410,1668760, }, }, --팀 전체부활
...
--	{ ModeID = 103, EnterTicket = { GOLDTRAIN_TICKET, 1, }, BossTicket = {}, },	
	{ ModeID = 117, EnterTicket = { GOLDTRAIN_TICKET, 1, }, BossTicket = {},	},	
--[[  
  Sample
    {
        ModeID = 8,
...
--[[
	...
	{ ModeID = 75, EnterTicket = { NIGHTMARKET_TICKET, 1, }, BossTicket = {}, },
	{ ModeID = 82, EnterTicket = { DEMO_DUNGEON_TICKET, 1, }, BossTicket = {}, },
	{ ModeID = 83, EnterTicket = { SHOOTING_EVENT_TICKET, 1, }, BossTicket = {}, },
	{ ModeID = 106, EnterTicket = { KING_SLIME_DUNGEON_TICKET, 1, }, BossTicket = {}, },	
	--]]
}
